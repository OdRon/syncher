    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="hpanel">
                ...
                {{ Form::open(['url' => '/lab/allocation/'. $allocation->id . '/edit', 'method' => 'put', 'class'=>'form-horizontal']) }}
                @endif
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            @php
                                if ($globaltesttype != 'CONSUMABLES') {
                                    $tests = $allocation->machine->testsforLast3Months($data->lab_id)->$globaltesttype;
                                    $qualamc = 0;
                                }
                            @endphp
