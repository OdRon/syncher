<p>
	...
	Please Log in to <a href='http://eiddash.nascop.org/'></a> with your usual username but with a password of {{ $password }}. Once you log in please change you password to your desired password.
	<br />

	Please note your registered email is {{ $email }}
	<br />
