...
class CreateSampleCompleteViewsTable extends Migration
{
    ...
    public function up()
    {
        ...
        (
          ...
          p.original_patient_id, p.patient_status, p.patient, p.sex, p.dob, p.ccc_no, p.mother_id, m.original_mother_id, m.patient_id as mother_vl_patient_id, m.ccc_no as mother_ccc_no,
