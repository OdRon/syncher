...
class CreateViralsampleCompleteViewsTable extends Migration
{
    ...
    public function up()
    {
        ...
        (
          ...
          p.original_patient_id, p.patient, p.sex, p.dob, g.gender_description, rs.name as receivedstatus_name, vp.name as prophylaxis_name, vj.name as justification_name, vs.name as sampletype_name
