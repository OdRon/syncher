...
class CreateSampleCompleteViewsTable extends Migration
{
    ...
    public function up()
    {
        ...
        (
          ...
          p.original_patient_id, p.patient, p.sex, p.dob, p.mother_id, p.entry_point, g.gender_description, rs.name as receivedstatus_name, mp.name as mother_prophylaxis_name, ip.name as regimen_name, f.feeding as feeding_name, f.feeding_description
